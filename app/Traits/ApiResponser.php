...
trait ApiResponser
{
     ...
     */
    protected function errorResponse($message, int $code = 500, $trace = null, $data = null)
    {
    ...
    protected function showResult($message, $data, int $code = 200)
    {
    ...
    protected function showResultV2($message, $data, int $code = 200)
    {
